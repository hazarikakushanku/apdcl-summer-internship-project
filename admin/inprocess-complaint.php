...
<?php 
$st='in process';
$query=mysqli_query($con,"select tblcomplaints.*,users.userconsumernumber as consumernumber from tblcomplaints join users on users.id=tblcomplaints.userId where tblcomplaints.status='$st'");
