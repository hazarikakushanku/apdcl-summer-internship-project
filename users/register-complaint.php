...
$query=mysqli_query($con,"insert into tblcomplaints(userId,category,subcategory,complaintType,region,noc,complaintDetails,complaintFile) values('$uid','$category','$subcat','$complaintype','$region','$noc','$complaintdetials','$compfile')");
...
<?php $sql=mysqli_query($con,"select regionName from region ");
while ($rw=mysqli_fetch_array($sql)) {
  ?>
  <option value="<?php echo htmlentities($rw['regionName']);?>"><?php echo htmlentities($rw['regionName']);?></option>
<?php
}
?>
